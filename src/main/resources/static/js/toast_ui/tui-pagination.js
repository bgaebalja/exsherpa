...
(function webpackUniversalModuleDefinition(root, factory) {
    if (typeof exports === 'object' && typeof module === 'object')
        module.exports = factory(require("webapp/resources/js/toast_ui/tui-code-snippet"));
    else if (typeof define === 'function' && define.amd)
        define(["webapp/resources/js/toast_ui/tui-code-snippet"], factory);
    else if (typeof exports === 'object')
        exports["Pagination"] = factory(require("webapp/resources/js/toast_ui/tui-code-snippet"));
    else
        ...
        /******/ ([
            ...
            /***/ (function (module, exports, __webpack_require__) {
                ...
                var defaultOption = {
                    ...
                    template: {
                        page: `<a href="#" class="custom_paging custom_paging_btn">{{page}}</a>`,
                        currentPage: `<a class="custom_paging custom_paging_btn custom_paging_btn_on">{{page}}</a>`,
                        moveButton: type => {
                            let template = '';
                            if (type.type === 'first') {
                                template = `<a class="custom_paging custom_paging_btn"><<</a>`;
                        ...
                        disabledMoveButton:
                            `<a class="custom_paging custom_paging_btn custom_paging_disable">{{type}}</a>`,
                        moreButton:
                            `<a href="#" class="custom_paging custom_paging_btn">...</a>`
                    }
                };
                ...
                var Pagination = snippet.defineClass(/** @lends Pagination.prototype */{
                    ...
                    /**
                     * 2022-06-03 perPage getter 제작
                     */
                    getPerPage: function () {
                        return this._options.itemsPerPage;
                    }
