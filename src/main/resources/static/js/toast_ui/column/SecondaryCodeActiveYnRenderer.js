class SecondaryCodeActiveYnRenderer {
    constructor(props) {
        ...
        if (value == 'Y') {
            ...
            tag = `<a class="btn btn_gray ml08" href="javascript:clickSave(${rowKey});">저장</a>`;
        }
    ...
    render(props) {
        ...
        if (value === 'N') {
            ...
            this.el.innerHTML = `<a class="btn btn_gray ml08" href="javascript:clickSave(${rowKey});">저장</a>`;
        }
